...
export default class Header extends React.Component {
  render() {
    return (
      <header
        id="masthead"
        className={"site-header " + _.get(this.props, "pageContext.site.siteMetadata.header.background", null)}
      >
            ...
            <div className="site-branding">
              {_.get(this.props, "pageContext.site.siteMetadata.header.profile_img", null) && (
                <p className="profile">
                  <Link to={withPrefix("/")}>
                    <img
                      // fixed={_.get(this.props, "pageContext.site.siteMetadata.header.profile_img", null)}
                      // objectFit="cover"
                      // objectPosition="50% 50%"
                      src={withPrefix(_.get(this.props, "pageContext.site.siteMetadata.header.profile_img", null))}
                      className="avatar"
                      alt={_.get(this.props, "pageContext.site.siteMetadata.header.profile_img_alt", null)}
                    />
                  </Link>
                </p>
              )}
                ...
                <div className="site-nav-wrap">
                  <div className="site-nav-inside">
                    {_.get(this.props, "pageContext.site.siteMetadata.header.has_nav", null) && (
                      <ul className="menu">
                        {_.map(
                          _.get(this.props, "pageContext.site.siteMetadata.header.nav_links", null),
                          (action, action_idx) => {
                            ...
                            return (
                              <li
                                ...
                                className={classNames("menu-item", {
                                  ...
                                  "menu-button": _.get(action, "style", null) === "button",
                                })}
                              >
                                <Link
                                  ...
                                  {...(_.get(action, "new_window", null) || _.get(action, "no_follow", null)
                                    ...
                                    : null)}
                                  className={classNames({ button: _.get(action, "style", null) === "button" })}
                                >
                    ...
                    {_.get(this.props, "pageContext.site.siteMetadata.header.has_social", null) && (
                      <div className="social-links">
                        {_.map(
                          _.get(this.props, "pageContext.site.siteMetadata.header.social_links", null),
                          (action, action_idx) =>
                            action && (
                              <Link
                                key={action_idx}
                                ...
                                className={classNames({
                                  "button button-icon": _.get(action, "style", null) === "icon",
                                })}
                              >
                                {_.get(action, "style", null) === "icon" && _.get(action, "icon_class", null) ? (
                                  <React.Fragment>
                                    <span className={"fab " + _.get(action, "icon_class", null)} aria-hidden="true" />
